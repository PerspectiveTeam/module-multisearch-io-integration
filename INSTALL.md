...
Для коректної роботи модуля необхідно, на стороні Multisearch.io, налаштувати індексацію фіда вашого магазину на ID, а не на значенню.   
Приклад: 
``` 
filters={"179":["84"],"191":["166"],"price":{"from":100,"to":5000}}
```
